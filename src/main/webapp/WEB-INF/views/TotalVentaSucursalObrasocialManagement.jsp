...
<html>
	<head>  
      ...
      <div class="generic-container" ng-controller="TVSOSDetalleFacturaController as ctrl">
              ...
              <div class="tablecontainer">
                  <table class="table table-striped table-hover table-bordered">
                      <thead class="thead-dark">
						...
						<tbody>
                          	<tr ng-repeat="df in ctrl.tvsosDetalleFacturas">
      	...
      	<script src="<c:url value='js/controller/totalVentasSucursalObraSocialDetalleFactura_controller.js' />"></script>
	</body>
</html>