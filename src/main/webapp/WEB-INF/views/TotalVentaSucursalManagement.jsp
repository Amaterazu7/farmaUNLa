...
<html>
	<head>  
      ...
      <div class="generic-container" ng-controller="TotalVentasSucursalDetalleFacturaController as ctrl">
              ...
              <div class="tablecontainer">
                  <table class="table table-striped table-hover table-bordered">
                      <thead class="thead-dark">
						...
						<tbody>
                          	<tr ng-repeat="df in ctrl.totalVentasSucursalDetalleFacturas">
      	...
      	<script src="<c:url value='js/service/totalVentasSucursalDetalleFactura_service.js' />"></script>
