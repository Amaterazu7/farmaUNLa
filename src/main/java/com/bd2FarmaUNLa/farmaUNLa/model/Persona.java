...
public class Persona {
	...
	public Persona(int id, int dni, String numAfiliado, String apellido, String nombre, String calle, String numero, Provincia provincia, Localidad localidad, ObraSocial obraSocial) {
		this.id = id;
		this.dni = dni;
